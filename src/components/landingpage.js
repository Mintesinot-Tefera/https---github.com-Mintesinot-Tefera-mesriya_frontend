...
function LandingPage() {
  ...
  return (
    <div className="h-screen p-20 bg-gray-300">
      <div className="grid grid-cols-2 bg-gradient-to-r from-pink-900 to-sky-900 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 px-5 py-20 h-full">
        <div className="grid grid-rows-3 gap-4">
          <a href="#">
            <h5 className="text-white text-xl font-semibold tracking-tight dark:text-white place-self-center">
