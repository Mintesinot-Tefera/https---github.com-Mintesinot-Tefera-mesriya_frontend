...
import { LOAD_TENDERS, PROPOSALS_OF_LOGGED_IN_USER } from "../GraphQL/Queries";

function ProposalListMine() {
    ...
    const { error, loading, data } = useQuery(PROPOSALS_OF_LOGGED_IN_USER, {
...
export default ProposalListMine;
