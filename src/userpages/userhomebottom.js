...
function UserHomeBottom() {
  ...
  //   <div class="pb-3 px-6 border-b border-gray-300">ተመራጭ ጨረታዎች</div>
  //   <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
  //     <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
  //       <li class="mr-2" role="presentation">
  //         <button class="inline-block p-4 rounded-t-lg border-b-2 text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="true">ላንተ</button>
  //       </li>
  //       <li class="mr-2" role="presentation">
  ...
  return (
    <div className="bg-gray-300 shadow-lg rounded mx-8 my-4 p-8  md:bg-orange h-35 border-2">
      <div class="pb-3 px-6 border-b border-gray-400 text-lg text-sky-800">ተመራጭ ጨረታዎች</div>

      <div class="mb-4 border-b border-gray-200 dark:border-gray-700 bg-gray-300"></div>
